...
//	public static String APP_SECRET = "f4c25191aa4d9606bce7af50fa37f2df";//应用secret-----登录平台在应用设置可以找到
	public static String APP_ID = "270980690000274645";//应用ID------登录平台在应用设置可以找到
	public static String APP_SECRET = "323a552e6100002d99ae5b91dfa69578";//应用secret-----登录平台在应用设置可以找到
...
//		System.out.println(res_code);
	...
	public static void main(String[] args) {
		Object result = "";
		try {
				result = sendSms("18662815187",RandomUtil.randomFor6());
