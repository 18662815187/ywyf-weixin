...
public class PhHos implements Serializable {
    private Integer id;
    ...
    public String getDisHosName() {
        return disHosName;
    }

    public void setDisHosName(String disHosName) {
        this.disHosName = disHosName == null ? null : disHosName.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", disHosName=").append(disHosName);
