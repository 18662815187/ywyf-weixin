...
function collection(ob) {
	if($(ob).find("p").text() == "收藏") {
		$(ob).find("img").attr("src", "../ywyf-weixin/img/xin (2).png")
		$(ob).find("p").text("已收藏").css("color","#cc0000")
	} else {
		$(ob).find("img").attr("src", "../ywyf-weixin/img/xin (1).png")
...
function spec_l() {
	$(".black_spec_l").remove()
	$(".black_spec_o").append('<img src="../ywyf-weixin/img/sys_item.gif" class="black_spec_l"/>')
}